...
# Due to the need to compare the similarity of gold answers for different data,
# we set the options with the uncertain meanings to the same option position. For BBQ dataset, the option position is set to C
dataset_name='bbq'
...
induct_model_name="Qwen2.5-7B-Instruct"
